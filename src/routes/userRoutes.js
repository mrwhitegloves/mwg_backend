...
const { sendOtp, verifyOtp, register, login, getMe, profile, vehicle, location, refreshToken, avatar_upload_url, getAllUsers, getUserById, updateUserStatus, deleteUser, addDeliveryAddress, getDeliveryAddresses, updateVehicle, logout, updateProfile, getBrands, getModelsByBrand } = require('../controllers/userController');
